...
import org.jetbrains.kotlin.idea.decompiler.HasCompiledKotlinInJarMeta;
...
public class PluginStartupComponent implements ApplicationComponent {
    ...
    public void initComponent() {
        ...
        JarMetaInformationIndex.INSTANCE$.register(KotlinJavaScriptLibraryDetectionUtil.KotlinJarMetaJavascriptInfoIndex.INSTANCE$);
        JarMetaInformationIndex.INSTANCE$.register(HasCompiledKotlinInJarMeta.INSTANCE$);
