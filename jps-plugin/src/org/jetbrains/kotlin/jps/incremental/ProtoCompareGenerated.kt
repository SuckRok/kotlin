...
public fun ProtoBuf.Type.toDataClass(nameResolver: NameResolver, enumerate: (String) -> Int): ProtoBufType {
    ...
    return ProtoBufType(argumentList, nullable, flexibleTypeCapabilitiesId, flexibleUpperBound, constructorClassName, constructorTypeParameter, typeAnnotationList)
}
